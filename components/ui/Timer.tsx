...
const Timer = () => {
  ...
  return (
    <div ref={container} className="text-white w-full h-[100vh] flex flex-col items-center pt-[15vh]">

        <h1 className="text-4xl mb-[5vh] opacity-1" id="hack-text">Hacking starts in <span id="dot" className="opacity-0">.</span><span id="dot" className="opacity-0">.</span><span id="dot" className="opacity-0">.</span></h1>

        {/* <div className="glow absolute -z-10 aspect-square bg-blue-400/20 blur-3xl filter w-full max-w-xl rounded-full"></div> */}
        <h1 id="timer" className="text-[50px] opacity-0 sm:text-[80px] md:text-[100px] lg:text-[160px] leading-tight h-[20vh] max-sm:h-[10vh] text-slate-300">
            {days} : {hours} : {minutes} : {seconds}
        </h1>

        <div className="flex w-full justify-around text-[50px] max-sm:flex-col items-center md:m-10">
            <p className="m-6">May 04</p>
            <p className="m-6 bg-gradient-to-r from-cyan-500 to-blue-500 bg-clip-text text-transparent">@CEP</p>
        </div>
        <div className="flex justify-around mt-[5vh] w-full max-sm:flex-col items-center">
            <p id="free-reg" className="inline m-6 mr-0 text-2xl font-bold bg-gradient-to-r from-cyan-500 to-blue-500 bg-clip-text text-transparent">Free Registration !</p>           
            <Button />
        </div>
    </div>
  )
